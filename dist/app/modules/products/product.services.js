...
const updateProductIntoDB = (id, updatedData) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield product_model_1.Product.findByIdAndUpdate(id, updatedData, {
        new: true,
    });
    return result;
});
